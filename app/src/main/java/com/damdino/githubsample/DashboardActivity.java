...
public class DashboardActivity extends AppCompatActivity {
    ...
    private final String MAIN_TAG = "dada";

    private View LoginFragment;


    //xml de tanımlanan id değeri ,"dadadsa");
    //((secondFragment)secondFragment).MAIN_TAG;

    //loginfragment=(Fragment)findVievById(R.id.activity_dashboard_fragemtnLogin);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.add(R.id.dashboard_fragment, secondFragment);
